...
Generator.prototype.normalizeJSON = function(obj) {
  ...
  return JSON.stringify(obj, null, this.getIndentChar());
};

Generator.prototype.filterNormalizeJSON = function(data) {
...
Generator.prototype.filterNormalizeJS = function(data) {
...
Generator.prototype.filterNormalizeHTML = function(data) {
...
/**
 * Filter to convert a JavaScript file to CoffeeScript
 * @param  {Object} data The file data object
 * @return {Object}      The filtered data object
 */

Generator.prototype.filterJS2Coffee = function(data) {
  if (path.extname(data.path) !== ".js") {
    return data;
  }

  data.path = data.path.replace(/\.js$/, ".coffee");
  data.contents = require("js2coffee").build(data.contents, {
    indentation: this.getIndentChar(),
    single_quotes: false
  });
  return data;
};
...
/**
 * Generate an indent character string based on the config
 * @return {Stirng} Indent string
 */

Generator.prototype.getIndentChar = function() {
