...
/**
 * Set the environment specifics to hanlde user's configs.
 */

Generator.prototype.setEnv = function() {
  if (this.config.get("language") === "coffeescript") {
    this.dest.registerWriteFilter("js2coffee", this.filterJS2Coffee.bind(this));
    this.src.registerWriteFilter("js2coffee", this.filterJS2Coffee.bind(this));
  }
};
